  ...
  describe('Auth', () => {
    describe('Register', () => {
      ...
      it('should throw a ConflictException if user already exists', async () => {
        ...
        await request(httpServer).post('/v1/auth/register').send(registerDto);
      ...
      it('should throw a BadRequestException if no body provided to the request', async () => {
        await request(httpServer).post('/v1/auth/register').expect(400);
      });
    ...
    describe('Login', () => {
      ...
      it('should return 400 if no body provided', async () => {
        await request(httpServer).post('/v1/auth/login').expect(400);
      });
    });
    describe('Refresh', () => {
      let registerDto: RegisterDto;
      ...
      it('should return 401 if no refresh token is provided', async () => {
        return request(httpServer).post('/v1/auth/refresh').expect(401);
      });
